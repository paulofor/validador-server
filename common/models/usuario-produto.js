    ...
    */
    ...
    Usuarioproduto.PeriodoGratuito = function (chave, callback) {
        ...
        Usuarioproduto.findOne({ 'where': { 'chave': chave } }, (err, usuario) => {
            ...
            dias = DIA_PROMOCAO - Math.floor(Difference_In_Days);
            ...
            if (usuario.codigoPagSeguro) {
                ...
                let novo = {'dias' : dias, 'chave' : chave, 'dataHora' : dataCorrente };
                app.models.AcessoAssinatura.create(novo,(err,result) => {
